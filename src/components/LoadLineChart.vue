...
// Handle user-triggered changes from the Select
            ...
            <div class="grid col-12 align-items-center border-y-1 border-400">
                <div class="col-4 py-2">
                    <div class="text-left">
                        <div class="text-left">
                            Tube
                            <Select v-model="selectedTube" :options="tubes" optionLabel="name" optionValue="id"
                ...
                <div class="col-4 py-2">
                    <div class="text-left">
                        Model
                        <Select v-model="selectedModel" :options="models" optionLabel="name" optionValue="id"
